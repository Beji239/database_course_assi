...
BEGIN
	...
	INSERT INTO tbl_persons (
		 ...
		 VALUES
		  ('bob', 'smith', '235-500-5555'),
		  ('john', 'doe', '333-555-6666'),
		  ('mary', 'danavan', '233-504-5775'),
		  ('marty', 'jones', '337-545-6226'),
		  ('joe', 'black', '666-666-6666');


	SELECT * FROM tbl_persons;
	SELECT person_fname, person_lname, person_contact FROM tbl_persons WHERE persons_id BETWEEN 1 AND 5 ; 
	SELECT person_fname, person_lname, person_contact FROM tbl_persons WHERE person_lname LIKE 'Sm%'; 
	SELECT person_fname, person_lname, person_contact FROM tbl_persons WHERE person_lname LIKE '_la%k';
	SELECT person_fname AS 'Firstname', person_lname AS 'Lastname', person_contact AS Phone FROM tbl_persons WHERE person_fname LIKE 'm%';
	DELETE FROM tbl_persons WHERE person_fname = 'joe';
	SELECT * FROM tbl_persons;
	...
	INSERT INTO tbl_care (
		 ...
		 ('care_1', 'repaire or replace brocken toys', 4),
	...
	INSERT INTO tbl_specialist(
		 ...
		 VALUES
		 ('margaret', 'neguen', '333-444-1223'),
		 ('mary', 'fisher', '444-555-2334'),
		 ('arnold', 'holkden', '555-666-3445'),
		 ('kem', 'byesan', '666-777-4556'),
		 ('joe', 'black', '777-888-5667')
	;
